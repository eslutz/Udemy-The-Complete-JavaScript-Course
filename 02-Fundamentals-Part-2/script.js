...
const pop1 = percentageOfWorld1(1441), pop2 = percentageOfWorld1(350), pop3 = percentageOfWorld1(2790);
const pop4 = percentageOfWorld2(1441), pop5 = percentageOfWorld2(350), pop6 = percentageOfWorld2(2790);
...
const percentageOfWorld3 = (population) => { return population / worldPopulation * 100 };
const pop7 = percentageOfWorld2(1441), pop8 = percentageOfWorld2(350), pop9 = percentageOfWorld2(2790);
...
const describePopulation = (country, population) => {
    return `${country} has a population of ${population} people, which is ${percentageOfWorld1(population)}% of the world population.`
};
...
console.log('last friend - friends[friends.length - 1]', friends[friends.length - 1]);
friends[1] = 'Chandler';
console.log('friends', friends);
...
if (!neighbors.includes('Germany')) {
    console.log("neighbors.includes('Germany')", neighbors.includes('Germany'), 'Probably not a central European country ☹️');
}
...
console.log(`${myCountry.country} has a population of ${myCountry.population} million people, has ${myCountry.neighbors.length} neighbor(s) and it's capital is ${myCountry.capital}.`);
...
const itsMeAgain = {
    ...
    personalSummary: function () {
        return `${this.lastName}, ${this.firstName}: A ${this.calcAge()} year old ${this.job}, who has ${this.friends.length} friends and ${this.hasDriversLicense ? 'can' : 'cannot'} legally drive a car.`;
    }
};
...
console.log('percentages == percentages2', percentages.length === percentages2.length && JSON.stringify([...percentages].sort()) === JSON.stringify([...percentages2].sort()));
...
console.log('percentages == percentages3', percentages.length === percentages3.length && JSON.stringify([...percentages].sort()) === JSON.stringify([...percentages3].sort()));
